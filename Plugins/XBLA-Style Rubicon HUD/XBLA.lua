...
function Triggers.init()
  ...
  img.plasmaPistol = Images.new{path = "720p/alienwep.png"}
  img.ar = Images.new{path = "720p/arr.png"}
  img.missileLauncher = Images.new{path = "720p/spnkr.png"}
  img.flamethrower = Images.new{path = "720p/nebulon.png"}
  img.alienWeapon = Images.new{path = "720p/alien_weapon.png"}
  ...
  img.fillFull = Images.new{path = "720p/fill2.png"}
  img.fillEmpty = Images.new{path = "720p/fillshell2.png"}
  ...
  img.fusionPistolCrosshair = Images.new{path = "720p/ret_alien.png"}
  img.assaultRifleCrosshair = Images.new{path = "720p/ret_machinegun.png"}
  img.rocketCrosshair = Images.new{path = "720p/ret_rocket.png"}
  img.flameCrosshair = Images.new{path = "720p/ret_plasma.png"}
  img.alienWeaponCrosshair = Images.new{path = "720p/ret_null.png"}
...
--  img.namePanelFoe = Images.new{path = "720p/target-panel-foe.png"}
  ...
  rawpos.radarPosition = { x = 18, y = 14 }
  rawpos.radarCenter = { x = 18+64, y = 14+64 }
  ...
  rawpos.pistolOffset = { x = 55, y = 19 }
  rawpos.pistolClipOffset = { x = 160, y = 16 }
  rawpos.pistolClipReadoutOffset = { x = 41, y = 16 }
  
  rawpos.dualPistolsOffset = { x = 55, y = 19 }
  rawpos.dualPistolsClipOffset = { x = 268, y = 16 }
  rawpos.dualPistolsSpacer = 51
  rawpos.dualPistolsClipReadoutOffset = { x = 185, y = 24 }
  ...
  rawpos.fusionPistolOffset = { x = 53, y = 11 }
  rawpos.fusionPistolCellOffset = { x = 268, y = 12 }
  rawpos.fusionPistolCellReadoutOffset = { x = 34, y = 14 }
  
  rawpos.flamethrowerOffset = { x = 50, y = 10 }
  rawpos.flamethrowerCellOffset = { x = 310, y = 12 }
  rawpos.flamethrowerCellReadoutOffset = { x = 75, y = 14 }
  ...
  rawpos.assaultRifleOffset = { x = 46, y = 21 }
  ...
  rawpos.alienWeaponOffset = { x = 105, y = 12 }
  rawpos.mineReadoutOffset = { x = 45, y = 25 }
...
function Triggers.draw()
  ...
  if Player.weapons.desired then
    ...
    elseif wt == "alien weapon" then
      ...
      drawReserve(Player.items[weapon.primary.ammo_type].count .. "x", pos.mineReadoutOffset)
...
function drawReserve(text, offset)
  ...
  bgf:draw_text(text, hudR - img.weaponAreaHUD.width + offset.x - (rw / 2), hudB - offset.y - bgfAdjust, { 1, 1, 1, 1 })
end

function drawReserveR(text, offset)
  local rw, rh = bgf:measure_text(text)
  bgf:draw_text(text, hudR - offset.x - (rw / 2), hudB - offset.y - bgfAdjust, { 1, 1, 1, 1 })
end
